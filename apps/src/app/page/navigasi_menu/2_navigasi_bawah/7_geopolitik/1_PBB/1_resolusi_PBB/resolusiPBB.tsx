...
import PengajuanResolusiModal from "./pengajuanResolusiModals";
...
export default function ResolusiPBB({ selectedCountry }: ResolusiPBBProps) {
  // 🔥 State pembuka modal yang sudah dipisahkan
  ...
  // ===== LOGIKA SUBMIT DARI MODAL =====
  const handleResolutionSubmit = (data: any) => {
    const { resType, resDuration, resTarget, voteStats } = data;
