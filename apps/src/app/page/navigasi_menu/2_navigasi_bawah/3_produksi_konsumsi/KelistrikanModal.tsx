...
import { X, Zap, BatteryCharging, MapPin } from "lucide-react";
            ...
            <div className="bg-[#e4dac3]/25 border-2 border-[#C4B49C]/40 p-4 rounded-2xl shadow-sm">
              ...
              <div className="grid grid-cols-1 gap-3">
                <div className="bg-[#FAF6EE] border-2 border-[#C4B49C]/30 p-3 rounded-2xl">
                  <p className="text-[10px] font-black uppercase tracking-widest text-[#5c3c10]">Total Kapasitas Terpasang</p>
                  <p className="text-2xl font-black text-[#2e261a] mt-3">{totalCapacity.toLocaleString('id-ID')} MW</p>
                </div>
                <div className="bg-[#FAF6EE] border-2 border-[#C4B49C]/30 p-3 rounded-2xl">
                  <p className="text-[10px] font-black uppercase tracking-widest text-[#5c3c10]">Konsumsi Terestimasi</p>
                  <p className="text-2xl font-black text-[#2e261a] mt-3">{estimatedUsage.toLocaleString('id-ID')} MW</p>
                </div>
                <div className="bg-[#FAF6EE] border-2 border-[#C4B49C]/30 p-3 rounded-2xl">
                  <p className="text-[10px] font-black uppercase tracking-widest text-[#5c3c10]">Neraca Daya</p>
              ...
              <div className="mt-4 bg-[#FAF6EE] border-2 border-[#C4B49C]/30 p-4 rounded-2xl">
                <p className="text-[10px] font-black uppercase tracking-widest text-[#5c3c10]">Ringkasan Pemakaian Listrik</p>
                <p className="text-sm text-[#8b7e66] mt-1">Data ini menampilkan estimasi input/output grid listrik berdasarkan kapasitas pembangkit dan kebutuhan nasional.</p>
                <div className="grid grid-cols-1 gap-3 mt-4">
                  <div className="bg-[#f7f1e4] border border-[#C4B49C]/20 p-3 rounded-2xl">
                    <p className="text-[10px] uppercase tracking-widest text-[#5c3c10]">Input Listrik</p>
                    <p className="text-2xl font-black text-[#2e261a] mt-3">{totalCapacity.toLocaleString('id-ID')} MW</p>
                  </div>
                  <div className="bg-[#f7f1e4] border border-[#C4B49C]/20 p-3 rounded-2xl">
                    <p className="text-[10px] uppercase tracking-widest text-[#5c3c10]">Output / Beban</p>
                    <p className="text-2xl font-black text-[#2e261a] mt-3">{estimatedUsage.toLocaleString('id-ID')} MW</p>
                  </div>
                  <div className="bg-[#f7f1e4] border border-[#C4B49C]/20 p-3 rounded-2xl">
                    <p className="text-[10px] uppercase tracking-widest text-[#5c3c10]">Selisih</p>
                    <p className={`text-2xl font-black mt-3 ${balance >= 0 ? 'text-emerald-700' : 'text-rose-700'}`}>{balance >= 0 ? '+' : '-'}{Math.abs(balance).toLocaleString('id-ID')} MW</p>
                  </div>
                </div>
              </div>
            </div>
