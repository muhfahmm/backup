      ...
      <div className="bg-[#FAF6EE] border-4 border-[#C4B49C] rounded-2xl w-full max-w-6xl h-[84vh] overflow-hidden shadow-2xl flex flex-col relative font-sans pointer-events-auto">
        ...
        <div className="px-8 py-6 border-b-2 border-[#C4B49C]/30 flex items-center justify-between bg-[#FAF6EE] relative z-10 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-black text-[#5c3c10] tracking-tight leading-none uppercase">Ketahanan Pangan</h2>
              <p className="text-xs text-[#8b7e66] font-medium">Pengaruh ketahanan pangan terhadap kematian di {countryName}</p>
            </div>
          </div>
          ...
          <div className="space-y-6 animate-in fade-in duration-500">
            <div className="bg-white/60 border-2 border-[#C4B49C]/20 p-6 rounded-2xl shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-black text-[#8b7e66] uppercase tracking-wider">Indeks Ketahanan Pangan</p>
                  <p className="text-4xl font-black text-orange-700 mt-1">{indeks}%</p>
                </div>
                <div className="p-4 bg-orange-50 rounded-full border border-orange-200">
              ...
              <div className="mt-4 grid grid-cols-2 gap-4">
                <div className="bg-orange-50/60 p-3 rounded-xl border border-orange-200">
                  ...
                  <p className="text-xl font-black text-orange-700">× {factor.toFixed(3)}</p>
                </div>
                <div className="bg-rose-50/60 p-3 rounded-xl border border-rose-200">
                  ...
                  <p className="text-xl font-black text-rose-700">semakin rendah kematian</p>
                </div>
              </div>
