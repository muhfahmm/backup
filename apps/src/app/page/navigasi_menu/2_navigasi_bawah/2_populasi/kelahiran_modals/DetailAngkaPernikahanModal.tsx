      ...
      <div className="bg-[#FAF6EE] border-4 border-[#C4B49C] rounded-2xl w-full max-w-6xl h-[84vh] overflow-hidden shadow-2xl flex flex-col relative font-sans pointer-events-auto">
        ...
        <div className="px-8 py-6 border-b-2 border-[#C4B49C]/30 flex items-center justify-between bg-[#FAF6EE] relative z-10 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-black text-[#5c3c10] tracking-tight leading-none uppercase">Angka Pernikahan</h2>
              <p className="text-xs text-[#8b7e66] font-medium">Pengaruh pernikahan terhadap kelahiran di {countryName}</p>
            </div>
          </div>
          ...
          <div className="space-y-6 animate-in fade-in duration-500">
            <div className="bg-white/60 border-2 border-[#C4B49C]/20 p-6 rounded-2xl shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-black text-[#8b7e66] uppercase tracking-wider">Angka Pernikahan per Tahun</p>
                  <p className="text-4xl font-black text-pink-700 mt-1">
                    {(angkaPernikahan * 100).toFixed(1)}% <span className="text-lg text-[#8b7e66] font-bold">/ tahun</span>
                  </p>
                </div>
                <div className="p-4 bg-pink-50 rounded-full border border-pink-200">
              ...
              <div className="bg-[#e4dac3]/15 border border-[#C4B49C]/30 p-4 rounded-xl space-y-2 mt-2">
                <h4 className="text-xs font-black text-[#5c3c10] uppercase">Faktor Pengali Pernikahan</h4>
                <p className="text-sm font-bold text-[#2e261a]">× {marriageFactor.toFixed(3)}</p>
              </div>
            </div>
          </div>
        </div>
