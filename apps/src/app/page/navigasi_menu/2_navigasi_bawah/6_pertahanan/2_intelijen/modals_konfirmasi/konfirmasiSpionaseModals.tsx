    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40 pointer-events-auto backdrop-blur-[2px]">
      <div className="bg-[#FAF6EE] border-4 border-[#C4B49C] rounded-2xl w-full max-w-3xl overflow-hidden shadow-2xl flex flex-col relative font-sans pointer-events-auto animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-8 py-6 border-b-2 border-[#C4B49C]/30 flex items-center justify-between bg-[#FAF6EE] relative z-10 shrink-0">
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-2xl font-bold text-[#5c3c10] tracking-tight leading-none uppercase">Konfirmasi Spionase</h2>
        ...
        <div className="flex-1 min-h-0 overflow-y-auto p-8 bg-[#FAF6EE]/40 relative z-10 no-scrollbar flex flex-col items-center justify-center">
          <div className="w-full max-w-lg space-y-8">
            <div className="flex justify-center">
              <div className="p-6 rounded-full bg-indigo-100 border border-indigo-300 shadow-inner">
                <Binoculars className="w-20 h-20 text-indigo-700" />
              </div>
            </div>
            ...
            <div className="text-center space-y-3">
              ...
              <p className="text-sm text-[#8b7e66] font-medium leading-relaxed max-w-lg mx-auto">
                Kirim agen rahasia untuk mengumpulkan data intelijen vital negara {targetName}.
                Biaya operasional diperkirakan sebesar <span className="font-black text-[#5c3c10]">10.000.000 EM</span>.
              </p>
            </div>

            <div className="bg-white/80 border border-[#C4B49C]/30 p-6 rounded-2xl shadow-sm flex flex-col items-center">
              <p className="text-[10px] font-black uppercase tracking-wider text-[#8b7e66] mb-1">Target Misi</p>
              <p className="text-lg font-black text-indigo-700">{targetName}</p>
        ...
        <div className="px-8 py-4 border-t-2 border-[#C4B49C]/30 bg-[#FAF6EE]/80 relative z-10 shrink-0 flex items-center justify-end gap-4">
          ...
          <button
            onClick={onConfirm}
            className="px-8 py-2.5 rounded-xl bg-indigo-700 text-[#FAF6EE] shadow-lg shadow-indigo-900/30 font-black text-xs uppercase tracking-wider hover:bg-indigo-800 active:scale-95 transition-all cursor-pointer flex items-center gap-2"
          >
