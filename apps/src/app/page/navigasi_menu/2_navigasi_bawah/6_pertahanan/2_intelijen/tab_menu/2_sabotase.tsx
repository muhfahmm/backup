...
export default function Sabotase({ anggaran, onAction }: SabotaseProps) {
  return (
    <div className="space-y-6 w-full">
      <p className="text-xs text-[#8b7e66] font-semibold leading-relaxed text-justify">
        Lancarkan aksi sabotase diam-diam untuk menghancurkan fasilitas produksi, jalur logistik, atau instalasi militer vital negara target.
      </p>
      ...
      >
        Luncurkan Misi Sabotase (20.000.000 EM)
      </button>
    </div>
  );
}