...
export default function BerikanSanksiModal({ isOpen, countryName, onClose, onConfirm }: BerikanSanksiModalProps) {
	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
			<div className="w-[420px] bg-white rounded-2xl p-6 shadow-lg border border-[#E5DCCF]">
				...
				<p className="text-sm text-[#5c3c10] mb-6">Berikan sanksi terhadap <strong>{countryName}</strong>? Sanksi dapat berupa embargo perdagangan atau pembatasan diplomatik.</p>
