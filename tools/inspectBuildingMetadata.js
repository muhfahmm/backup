...
(async ()=>{
  ...
  console.log('PLTN metadata:', metadata['pembangkit_listrik_tenaga_nuklir']);
  // print some keys around electricity
  console.log('Sample keys:', Object.keys(metadata).filter(k=>k.includes('pembangkit')||k.includes('listrik')).slice(0,20));
})();
